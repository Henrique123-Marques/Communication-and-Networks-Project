...
# Exemplo de cálculo de fluxo máximo entre duas estações
origem = 'Brás'
destino = 'República'
# Calcular o fluxo máximo entre origem e destino
...
# Exemplo de cálculo de caminho mínimo entre duas estações
origem = 'Brás'
destino = 'República'
...
# Cálculo da distância do caminho mínimo
